...
{
	if (url)
		poop("desc_effect.php?whicheffect=" + url, "effect", 200, 300);
}
function outfit(url)
{
	if (url)
		poop("desc_outfit.php?whichoutfit=" + url, "effect", 200, 300);
}
function item(url)
{
	if (url)
		poop("desc_item.php?whichitem=" + url, "", 200, 300);
}
function descitem(url,otherplayer,ev)
{
	...
	if (url)
		poop("desc_item.php?whichitem=" + url + oplay, "", 200, 300);
}
function skill(url)
{
	if (url)
		poop("desc_skill.php?whichskill=" + url, "skill", 350, 300);
}
function fam(url)
{
	if (url)
		poop("desc_familiar.php?which=" + url, "familiar", 200, 300);
}
function search(url)
{
